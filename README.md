...
sudo dnf install -y cockpit podman cockpit-podman podman-compose rclone fuse3 nano firewalld git zsh flatpak waypipe fastfetch tmux htop wget curl vnstat nload iftop
